        ...
        if (channel < this.i.length) {
            switch (component) {
                case MixComponent.level:
                    RampToValue(this.i[channel].gain, at_time, db2mag(value), smoothing_time);
                    break;
                case MixComponent.send_a:
                    RampToValue(this.sa_l[channel].gain, at_time, db2mag(value), smoothing_time);
                    break;
                case MixComponent.send_b:
                    RampToValue(this.sb_l[channel].gain, at_time, db2mag(value), smoothing_time);
                    break;
            ...
            console.log("Channel index,", channel, "exceeds number of channels. Number of Channels:", this.i.length);
        }
    }
